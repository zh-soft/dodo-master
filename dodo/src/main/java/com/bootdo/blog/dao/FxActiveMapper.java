 ...
 */
@Mapper
public interface FxActiveMapper {

	@Select("select `id`, `Initiator`, `from_time`, `end_time`, `address`, `budget_amount`, `active_users`, `description`, `create_time`, `update_time`, `create_user`, `update_user` from fx_active where id = #{id}")
	...
	@Insert("insert into fx_active (`Initiator`, `from_time`, `end_time`, `address`, `budget_amount`, `active_users`, `description`, `create_time`, `update_time`, `create_user`, `update_user`)"
	...
	@Delete("delete from fx_active where id =#{id}")
	int remove(Long id);
