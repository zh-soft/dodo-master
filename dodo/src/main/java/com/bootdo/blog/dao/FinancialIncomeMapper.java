...
public interface FinancialIncomeMapper {
	...
	@Select("select `id`, `user_id`, `income_type`, `income_amount`, `unit`, `income_date`, `income_status`, `data_url`, `description`, `create_time`, `update_time`, `create_user`, `update_user` from financial_income where id = #{id}")
	...
	@Insert("insert into financial_income (`user_id`, `income_type`, `income_amount`, `unit`, `income_date`, `income_status`, `data_url`, `description`, `create_time`, `update_time`, `create_user`, `update_user`)"
	...
	@Delete("delete from financial_income where id =#{id}")
	int remove(Long id);
