 ...
 */
@Mapper
public interface FinancialAcountMapper {

	@Select("select `id`, `expend_id`, `income_id`, `acount_type`, `total_expend`, `total_income`, `total_acount`, `old_acount`, `create_time`, `update_time`, `create_user`, `update_user` from financial_acount where id = #{id}")
	...
	@Insert("insert into financial_acount (`expend_id`, `income_id`, `acount_type`, `total_expend`, `total_income`, `total_acount`, `old_acount`, `create_time`, `update_time`, `create_user`, `update_user`)"
	...
	@Delete("delete from financial_acount where id =#{id}")
	int remove(Long id);
